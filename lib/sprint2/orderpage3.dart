...
// void main() {
//   runApp(MaterialApp(
//     home: OrderPage3(subText: '', inputText: '',data: {}),
//   ));
// }
//
...
//
//   const OrderPage3({super.key, required this.subText , required this.inputText, required this.data});
//
//
//   @override
...
//                             onPressed: () {
//                               if(Product.quantity.isNaN) {
//                                 // Create a new instance of the Product class with the selected data
//                                 // Navigate to the next page and pass the selected product
//                               }else {
//                                 Navigator.push(
//                                   context,
//                                   MaterialPageRoute(
//                                     builder: (context) =>
//                                         NextPage(product: Product),
//                                   ),
//                                 );
//                               }
//                             },
