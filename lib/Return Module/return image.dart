...
//                                           secondaryAnimation) =>
//                                           CreateReturn(storeImage: 'hi', imageSizeString: imagenameController.text, imageSizeStrings: widget.imageSizeStrings, storeImages: widget.storeImages, orderDetails: widget.orderDetails,orderDetailsMap: widget.orderDetailsMap,),
//                                       transitionDuration:
//                                       const Duration(milliseconds: 200),
//                                       transitionsBuilder: (context, animation,
//                                           secondaryAnimation, child) {
...
void main(){
  runApp(MaterialApp(home: ReturnImage(orderDetails: [], storeImages: [], orderDetailsMap: {}, imageSizeStrings: [],),));
}
...
class _ReturnImageState extends State<ReturnImage> {
  ...
  //this is last edited last one is original
  // Future<void> filePicker() async {
  //   result = await FilePicker.platform.pickFiles(type: FileType.image);
  //   if (result == null) {
  //   } else {
  ...
  //       selectedImages.clear(); // Clear previous selections
  //     });
  //     List<String> tempImageSizes = []; // Create a temporary list
  //     for (var element in result!.files) {
  //       setState(() {
  //         imageIdController.text = element.name;
  //       });
  ...
  //       print('Image size: $imageSizeString');
  //
  //       tempImageSizes.add(imageSizeString); // Add image size to the temporary list
  //       uploadImage(element.name); // Pass image bytes to uploadImage
  //       setState(() {
  //         selectedImages.add(element.bytes!);
  //       });
  //     }
  //     setState(() {
  //       widget.imageSizeStrings.addAll(tempImageSizes); // Add all elements to widget.imageSizeStrings
  //     });
  //   }
  // }
                          ...
                          onPressed: () {
                            ...
                            Navigator.push(
                              ...
                              PageRouteBuilder(
                                pageBuilder: (context, animation,
                                    secondaryAnimation) =>
                                    CreateReturn(orderDetailsMap: {}, storeImage: '', imageSizeStrings: [], storeImages: [], orderDetails: [],imageSizeString: '',),
                                transitionDuration:
                                const Duration(milliseconds: 200),
                                transitionsBuilder: (context, animation,
                                    secondaryAnimation, child) {
