...
class MyApp extends StatelessWidget {
  ...
  return ProductForm1(
      ...
      GoRoute(
          path: '/dasbaord/productpage/ontap',
          builder: (context, state) {
...
// import 'package:btb/First%20page/login.dart';
// import 'package:flutter/material.dart';
//
// void main() {
//   runApp(const MyApp());
...
//         builder: (context, state) => LoginScr(),
//       ),
//       GoRoute(
//         path: PageName.dashboardRoute,
//         builder: (context, state) => Dashboard(),
//         routes: [
//           GoRoute(
//               path: PageName.subpage1,
//               builder: (context, state) => SecondPage(),
//               routes: [
//                 GoRoute(
//                   path: PageName.subsubPage1,
//                   builder: (context, state) => ProductPage(product: null),
//                 )
//               ]),
//           GoRoute(
//               path: PageName.subpage2,
//               builder: (context, state) => ProductPage(
//                     product: null,
//                   ),
//               routes: [
//                 GoRoute(
//                   path: PageName.subpage2Main,
//                   builder: (context, state) {
//                     return ProductForm1(
//                       displayData: {},
//                       // imageName: ,
...
//         routes: [
//           GoRoute(
//             path: PageName.subpage1Main,
//             builder: (context, state) => Dashboard(),
//           ),
//           // GoRoute(
//           //   path: PageName.subpage2Main,
//           //   builder: (context, state) => ProductForm1(product: null, productData: productData,),
//           // ),
//         ],
//       ),
//     ],
...
//                 GoRoute(
//                   path: PageName.subsubPage1,
//                   builder: (context, state) => const ProductPage(product: null),
//                 )
//               ]),
//           GoRoute(
//               path: PageName.subpage2,
...
//                         selectedValue3: null,
//                         imagePath: null,
//                         displayData: {}, /* from productclass.dart */
//                         // other parameters
//                       );
//                     },
//                     routes: [
//                       GoRoute(
//                         path: PageName.subsubpage2Main,
//                         builder: (context, state) {
//                           final arguments = state.extra as Map<String, dynamic>;
//                           return EditOrder(
//                             prodId: arguments['prodText'],
//                             textInput: arguments['textInput'],
//                             priceInput: arguments['priceInput'],
//                             productData: arguments['productData'],
//                             discountInput: arguments['discountInput'],
//                             inputText: arguments['inputText'],
//                             subText: arguments['subText'],
//                             unitText: arguments['unitText'],
//                             taxText: arguments['taxText'],
...
// import 'dart:convert';
//
// import 'package:btb/eighth%20page/first%20page.dart';
// import 'package:btb/eighth%20page/orderspage3.dart';
// import 'package:btb/eighth%20page/sprint%202.dart';
// import 'package:btb/fifthpage/Edit.dart';
// import 'package:btb/seconpage/dashboard.dart';
// import 'package:btb/sixth%20page/thirdpage%201.dart';
// import 'package:btb/thirdpage/secondfinal.dart';
//
// import 'package:btb/useless/productclass.dart';
// import 'package:flutter/material.dart';
// import 'package:go_router/go_router.dart';
//
...
//   static const homeRoute = '/';
//   static const dashboardRoute = '/dashboard';
//   static const subpage1 = 'addproduct'; // Relative path, no leading slash
//   static const subpage2 = 'subpage2'; // Relative path, no leading slash
//   static const subsubPage1 = 'subsubPage1';
//   static const main = '/main';
//   //  static const dashboardRoute1 = '/dashboard1';
...
//   static const subpage2Main = 'subpage2Main';
//   static const subpage22main = 'subpage22main';
//   static const subsubpage2Main = 'subsubpage2Main'; // Relative path, no leading slash
// }
//
// class MyApp extends StatelessWidget {
//   final _router = GoRouter(
...
//       GoRoute(
//         path: '/dashboard',
//         builder: (context, state) => const Dashboard(fid: ''),
//       ),
//       GoRoute(
//         path: '/dashboard/addproduct',
//         builder: (context, state) => const SecondPage(fid: ''),
//       ),
//       GoRoute(
//         //remain me to use as last sprint consult wtih krishna sir
//         path: '/addproduct/dashboard',
...
//         path: '/dasbaord/productpage/:product',
//         builder: (context, state) {
//           final product = state.extra as Product1?;
//           return ProductPage(product: product);
//         },
//       ),
//       GoRoute(
...
//           builder: (context, state) {
//             final product = state.extra as Product1?;
//             return ProductForm1( displayData: const {},
//               prodId: product?.prodId,
//               imagePath: null,
//               productText: null,
//               priceText: null,
...
//         builder: (context, state) {
//           // final params = state.extra as Map<String, dynamic>;
//           final textInput = state.pathParameters['textInput'];
//           return EditOrder(
//             prodId: '',
//             textInput: textInput,
//             priceInput: '',
...
//       ),
//       GoRoute(
//         path: '/dashboard/productpage/ontap/Edit/Update',
//         builder: (context, state) {
//           final params = state.extra as Map<String, dynamic>;
//           return ProductForm1(
//             prodId: params['prodId'],
//             priceText: params['price'],
//             productText: params['productName'],
//             discountText: params['discount'],
//             selectedValue1: params['subCategory'],
//             selectedValue: params['category'],
//             selectedValue3: params['tax'],
//             selectedvalue2: params['unit'],
//             displayData: jsonDecode(params['productData']),
//             imagePath: null,
//             product: null,
//           );
//         },
...
//       // ),
//       // GoRoute(
//       //   path: '/dasbaord/Orderspage/addproduct/addparts/:deliveryLocation/:ContactName/:Address/:ContactNumber/:Comments/:date',
//       //   builder: (context, state) {
...
//       //   path: '/dasbaord/productpage/:product',
//       //   builder: (context, state) {
//       //     final  product = state.pathParameters['product'] as ord.Product;
//       //     return ProductPage(product: product);
//       //   },
//       // ),
//     ],
