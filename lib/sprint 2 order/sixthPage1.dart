...
// import 'package:btb/sprint%202%20order/datatable.dart';
...
// void main(){
//   runApp( SixthPage(product: detail(orderId: '', orderDate: '', total: 0, status: '', deliveryStatus: '', referenceNumber: ''),),);
// }
//
//
...
//   detail _selectedOrder = detail(orderId: '', total: 0,deliveryStatus: '',status: '',orderDate: '',referenceNumber: '');
...
//           setState(() {
//             _orders = jsonData; // update _orders with all orders or search results
//             _errorMessage = ''; // clear the error message
//           });
//         } else {
//           setState(() {
...
//                                 }).toList(),
//                               };
//                               context.go('/selectedProduct', extra: data);
//                               Navigator.push(
//                                 context,
//                                 PageRouteBuilder(
//                                   pageBuilder: (context, animation,
//                                       secondaryAnimation) =>
//                                       SelectedProductPage(data: data, selectedProducts: [],),
//                                   transitionDuration:
...
//                             child: Container(
//                               decoration: BoxDecoration(
//                                 color: selectedIndex == index ? Colors.lightBlue[200] : Colors.white, //
...
//                                   'Order Placed', _isChecked1, ' ', (value) {
//                                 setState(() {
//                                   _isChecked1 = value;
//                                 });
//                               }),
...
//               ),
//               Padding(
//                 padding: const EdgeInsets.only(top: 290,left: 550,right: 20 ),
//                 child: Container(
//                   height: 350,
//                   width: 950,
...
//                               SizedBox(height: 0.8),
//                               DataTable(
//                                 // columnSpacing: constraints.maxWidth / 20,
...
//                         //           ? Table(
//                         //         border: TableBorder.all(color: Colors.black), // Set border for the table
//                         //         columnWidths: {
//                         //           0: FixedColumnWidth(30.0), // Width for SN column
//                         //           1: FlexColumnWidth(), // Flex column width for remaining columns
//                         //           2: FlexColumnWidth(),
//                         //           3: FlexColumnWidth(),
//                         //           4: FlexColumnWidth(),
//                         //           5: FlexColumnWidth(),
...
//                         //                 tableCell(item['subCategory']),
//                         //                 tableCell(item['price'].toString()),
//                         //                 tableCell(item['qty'].toString()),
//                         //                 tableCell(item['totalAmount'].toString()),
//                         //               ],
//                         //             );
//                         //           }).toList(),
//                         //         ],
...
//                         //
//                         //
//                         //       /// in this place i want to show the product item details understand
//                         //       //second listview
//                         //       // ListView.builder(
//                         //       //   shrinkWrap: true,
...
//                         //       //     final selectedItem = product['items'];
//                         //       //
...
//                         //       //                 child: Center(
//                         //       //                   child: Text(
//                         //       //                     (selectedItem.indexOf(item) + 1).toString(),
//                         //       //                     textAlign: TextAlign.center,
//                         //       //                   ),
//                         //       //                 ),
//                         //       //               ),
...
//                         //       //                   child: Center(
//                         //       //                     child: Text(
//                         //       //                       (double.parse(item['price'].toString()) * double.parse(item['qty'].toString())).toString(),
//                         //       //                       textAlign: TextAlign.center,
//                         //       //                     ),
//                         //       //                   ),
//                         //       //                 ),
...
//               //   children: [
//               //     Padding(
//               //       padding: const EdgeInsets.only(left: 550, top: 830),
//               //       child: SizedBox(
//               //         width: 955,
//               //         child: Card(
//               //           color: Colors.white,
