    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) {
        return MaterialApp(
          ...
          home: FifthPage(selectedProducts: [], data: {}, select: '',),
        );
      },
    );
  }
...
class _FifthPageState extends State<FifthPage> {
  ...
  Future<void> callApi() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (details != null) {
       // context.go('/sixthpage-from-fifthpage', extra: details);
        Navigator.push(
          context,
          PageRouteBuilder(
                          ...
                          children: [
                            ...
                            Container(
                                child:Column(
                                  children: [
                                    Padding(
                                      padding:  EdgeInsets.only(left: maxWidth * 0.67,top: 80,right: 100),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Padding(
                                          padding:  EdgeInsets.only(left: maxWidth * 0.72, top: 10,),
                                          child: DecoratedBox(
