...
class _OrderspageState extends State<Orderspage> {
      ...
      home: Scaffold(
        ...
        body: Stack(
          children: [
                        ...
                        child: Padding(
                          ...
                          child: OutlinedButton(
                            onPressed: () {
                              ...
                              context.go('/dasbaord/Orderspage/addproduct');
                              Navigator.push(
                                context,
                                PageRouteBuilder(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 250, top: 120,right: 150),
              child: Container(
                width: 1700,
                height: 1100,
  ...
  Widget buildDataTable() {
    return LayoutBuilder(builder: (context, constraints){
      double padding = constraints.maxWidth * 0.041;
                ...
                children: [
                  Container(
                    ...
                    child: DataTable(
                      headingRowHeight: 50,
                      columns: [
                        DataColumn(label: Container(padding:EdgeInsets.only(left: padding , right: right), child: Text('Status',style:TextStyle( color: Colors.indigo[900],   fontSize: 15,
                          fontWeight: FontWeight.bold,),))),
                        DataColumn(label: Container(padding: EdgeInsets.only(left: padding),child: Text('Order ID',style:TextStyle(                            color: Colors.indigo[900], fontSize: 15,
                            fontWeight: FontWeight.bold),))),
                        DataColumn(label: Container(padding: EdgeInsets.only(left: padding),child: Text('Created Date',style:TextStyle(                            color: Colors.indigo[900], fontSize: 15,
                            fontWeight: FontWeight.bold),))),
                        DataColumn(label: Container(padding: EdgeInsets.only(left: padding),child: Text('Reference Number',style:TextStyle(                            color: Colors.indigo[900], fontSize: 15,
                            fontWeight: FontWeight.bold),))),
                        DataColumn(label: Container(padding: EdgeInsets.only(left: padding),child: Text('Total Amount',style:TextStyle(                            color: Colors.indigo[900], fontSize: 15,
                            fontWeight: FontWeight.bold),))),
                        DataColumn(label: Container(padding: EdgeInsets.only(left: padding),child: Text('Delivery Status',style:  TextStyle(
                            color: Colors.indigo[900],
                            fontSize: 15,
                            fontWeight: FontWeight.bold),))),
                      ],
                      rows: snapshot.data!.map((detail) {
                        ...
                        return DataRow(
                            ...
                            cells: [
                              DataCell(
                                  MouseRegion(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        context.go('/sixthPage/ontap', extra: {
                                          'product': detail,
                              ...
                              DataCell(Container( padding: EdgeInsets.only(left: padding),child: Text(detail.orderId!))),
                              DataCell(Container( padding: EdgeInsets.only(left: padding),child: Text(detail.orderDate))),
                              DataCell(Container(padding: EdgeInsets.only(left: padding),child: Text(detail.referenceNumber))),
                              DataCell(Container(  padding: EdgeInsets.only(left: padding),child: Text(detail.total.toString()))),
                              DataCell(Container(padding: EdgeInsets.only(left: padding),child: Text(detail.deliveryStatus))),
