            ...
            child: SingleChildScrollView(
              ...
              child: Stack(
                children: [
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            SixthPage(product: detail(orderId: '',orderDate: '',referenceNumber: '',status: '',deliveryStatus: '',deliveryLocation: '',deliveryAddress: '',contactPerson: '',comments: '',contactNumber: '',value: '',items: [],total: 0))),
                                  );
                                },
                              ),
                            ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 250,left: 550,right: 20 ),
                    child: Container(
                      height: 350,
                      width: 950,
